    ...
    <div className={styles.main}>
      <div className={styles.container}>
        ...
        <section className={styles.section}>
          ...
          <p>
            <strong>Status:</strong> {mold.status}
          </p>
          <p>
            <strong>Prioridade:</strong> {mold.priority}
          </p>
          <p>
            <strong>Data de Entrega:</strong>{" "}
            {new Date(mold.delivery_date).toLocaleDateString()}
          </p>
          <p>
            <strong>Progresso:</strong> {mold.progress_percentage}%
          </p>
          <p>
            <strong>Quantidade:</strong> {mold.quantity}
          </p>
        </section>
          ...
          {mold.operation_associations.length === 0 ? (
            ...
            <ul>
              {mold.operation_associations.map((op) => (
                <li key={op.id}>
                  <strong>ID:</strong> {op.operation_id} -{" "}
